    ...
    <div className="resume-page">
      <Grid>
        <Cell col={4} className="resume-left-col">
          ...
          <p>
            Last year university student looking for a new experience and eager
            to learn new things, currently working on the final assignment and
            looking forward for work experience.
          </p>
          <h5>Address</h5>
